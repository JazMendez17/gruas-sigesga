                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full bg-[#E8EDF2] text-[#1F2937] placeholder-[#9CA3AF] rounded-2xl py-3 pl-12 pr-12 shadow-[inset_6px_6px_12px_#d0d5da,inset_-6px_-6px_12px_#ffffff] focus:outline-none focus:ring-2 focus:ring-indigo-300 transition-all duration-200"
                            />
                            <button
                                type="button"
