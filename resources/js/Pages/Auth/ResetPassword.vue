                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <input v-model="form.email" type="email" readonly
                                class="w-full bg-[#E8EDF2] text-[#1F2937] rounded-2xl py-3 pl-12 pr-4 shadow-[inset_6px_6px_12px_#d0d5da,inset_-6px_-6px_12px_#ffffff] focus:outline-none focus:ring-2 focus:ring-indigo-300" />
                        </div>
                    </div>

                    <div class="mb-5">
                        <label class="block text-sm font-medium text-[#4B5563] mb-2">Nueva contraseña</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg class="w-5 h-5 text-[#9CA3AF]" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
