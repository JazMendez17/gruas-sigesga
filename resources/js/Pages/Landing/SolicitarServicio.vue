                ...
                <form @submit.prevent="submitForm" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select v-model="form.tipo_servicio" required
                                class="w-full px-5 py-3.5 rounded-2xl bg-[#E8EDF2] shadow-[inset_6px_6px_12px_#d0d5da,inset_-6px_-6px_12px_#ffffff] text-gray-700 focus:outline-none">
                    ...
                    <div>
                        ...
                        <textarea v-model="form.descripcion" rows="4"
                                  class="w-full px-5 py-3.5 rounded-2xl bg-[#E8EDF2] shadow-[inset_6px_6px_12px_#d0d5da,inset_-6px_-6px_12px_#ffffff] text-gray-700 placeholder-gray-400 focus:outline-none resize-none"
